...
import pdfFile from '../../assets/2026-2027_Sponsorship_Packet.pdf';
...
export default function Sponsors() {
  ...
  return (
    <Box>
      ...
      <Box padding="0px 6%" mt={7}>
        <Typography variant="mobileH2" id="sponsor-box">
          OUR SPONSORS
        </Typography>
      ...
      button is not hovered over.*/}
        <Box display='flex' justifyContent="center" alignItems="center" mt="40px" mb="40px">
          <Box display='flex' gap="10px" justifyContent="center" flexDirection='column'>
            <Button href={pdfFile} target="_blank" rel="noopener noreferrer" sx={{ backgroundColor: "#820002", color: "white", fontSize: "1.2em", width: "100%", maxWidth: "330px", minWidth: "250px", height: "100px", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", px: "20px", borderRadius: "16px", '&:focus': { outline: 'none', }, '&:hover': { color: 'white' }, fontFamily: theme.typography.desktopBody.fontFamily }}>SPONSORSHIP PACKET</Button>
            <Button href={cornellDonate} target="_blank" rel="noopener noreferrer" sx={{ backgroundColor: "#820002", color: "white", fontSize: "1.2em", width: "100%", maxWidth: "330px", minWidth: "250px", height: "100px", textAlign: "center", display: "flex", alignItems: "center", justifyContent: "center", px: "20px", borderRadius: "16px", '&:focus': { outline: 'none', }, '&:hover': { color: 'white' }, fontFamily: theme.typography.desktopBody.fontFamily }}>DONATE</Button>
      ...
      screen. */}
        <Box display='flex' justifyContent="center" alignItems="center" sx={{ flexDirection: 'column' }}>
          <Typography align='left' variant="mobileBody" sx={{ my: 2 }}>
