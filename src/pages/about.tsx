  ...
  return (
    <Box sx={{ width: '100%', overflowX: 'hidden' }}>
      ...
      <Box
            ...
            <Box height="30%"
              ...
              <Stack direction="row" sx={{
                ...
                <Stack direction="column" alignItems="center" spacing="20px">
                  <Typography variant={isMobile ? "mobileH2" : "desktopH2"}>40+</Typography>
                  <Typography variant={isMobile ? "mobileBody" : "desktopH3"}>members</Typography>
                </Stack>

                <Stack direction="column" alignItems="center" spacing="20px">
                  <Typography variant={isMobile ? "mobileH2" : "desktopH2"}>20</Typography>
                  <Typography variant={isMobile ? "mobileBody" : "desktopH3"}>majors</Typography>
                </Stack>

                <Stack direction="column" alignItems="center" spacing="20px">
                  <Typography variant={isMobile ? "mobileH2" : "desktopH2"}>6</Typography>
                  <Typography variant={isMobile ? "mobileBody" : "desktopH3"}>colleges</Typography>
                </Stack>

                <Stack direction="column" alignItems="center" spacing="20px">
                  <Typography variant={isMobile ? "mobileH2" : "desktopH2"}>6+</Typography>
                  <Typography variant={isMobile ? "mobileBody" : "desktopH3"}>years</Typography>
                </Stack>
              </Stack>
            </Box>
          </Box>
        ...
        <Box sx={{ width: "98vw", mb: isMobile ? '15%' : '5%' }}>
